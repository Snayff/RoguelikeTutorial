...
ds_grid_set_region(oControllerTile.tileGrid, _startingTileX, _startingTileY, _startingTileX + _widthOfRoom, _startingTileY, (~ISBLOCKINGMOVEMENT) & (~ISBLOCKINGSIGHT) );
