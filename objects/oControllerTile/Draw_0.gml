...
for (var _arrayHeight = ds_grid_height(tileArray)-1; _arrayHeight >= 0; _arrayHeight--; ){
	for (var _arrayLength = ds_grid_width(tileArray)-1; _arrayLength >= 0; _arrayLength--; ){	
...
//	for (var _arrayLength = array_length_2d(tileArray, _arrayHeight)-1; _arrayLength >= 0; _arrayLength--; ){	
		...
		if ds_grid_get(tileArray, _arrayLength, _arrayHeight) & ISBLOCKINGMOVEMENT {
